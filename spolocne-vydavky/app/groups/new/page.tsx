...
const GROUP_TYPES: {
...
}[] = [
  {
    ...
    emoji: "🏠",
    label: "Rodina",
    desc: "Spoločný rozpočet, vreckové, úlohy pre deti",
  },
  {
    type: "roommates",
    emoji: "🛋️",
    label: "Spolubývajúci",
    desc: "Nájom, energie, spoločné nákupy",
  },
  {
    type: "peers",
    emoji: "✈️",
    label: "Skupina",
    desc: "Výlet, udalosť, predplatné — dočasná skupina",
  },
];
        ...
        {step === 1 && (
          <>
            ...
            <button
              ...
              style={{
                background: groupType ? "#0a84ff" : "#2c2c2e",
                color: groupType ? "#fff" : "#8e8e93",
              }}
            >
              Ďalej
            </button>
        ...
        {step === 2 && (
          <>
            ...
            <div className="text-[13px] mb-3" style={{ color: "#8e8e93" }}>
              Menom alebo číslom — bez zadávania IBAN
            </div>
            ...
            <div className="flex gap-3 mt-2">
              ...
              <button
                ...
                className="flex-1 py-4 rounded-2xl font-semibold text-[15px]"
                style={{
                  background: name.trim() ? "#0a84ff" : "#2c2c2e",
